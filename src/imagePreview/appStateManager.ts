...
export type ImageFormatType = 'png' | 'jpg' | 'ppm' | 'tiff-float' | 'tiff-int' | 'exr-float' | 'pfm' | 'npy-float' | 'npy-uint' | 'hdr' | 'tga' | 'webimage' | 'jxl' | 'raw';
...
export class AppStateManager {
	...
	private _getDefaultSettingsForFormat(format: ImageFormatType): ImageSettings {
		...
		if (format === 'npy-uint' || format === 'tiff-int' || format === 'ppm' || format === 'png' || format === 'jpg' || format === 'tga' || format === 'webimage' || format === 'jxl' || format === 'raw') {
