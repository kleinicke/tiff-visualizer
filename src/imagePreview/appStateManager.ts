...
export type ImageFormatType = 'png' | 'jpg' | 'ppm' | 'tiff-float' | 'tiff-int' | 'tiff-int-signed' | 'tiff-int-wide' | 'exr-float' | 'pfm' | 'hdr' | 'npy-float' | 'npy-uint' | 'tga' | 'webp' | 'avif' | 'bmp' | 'jxl' | 'fits' | 'dicom' | 'netcdf' | 'czi' | 'ora' | 'kra' | 'psd' | 'psb' | 'xcf' | 'affinity';
