...
export default defineConfig({
  ...
  testMatch: ['extension-core.spec.ts', 'layer-compositor-worker.spec.ts', 'gpu-layer-compositor.spec.ts', 'webgpu-layer-compositor.spec.ts', 'accelerator-speed.spec.ts', 'measure-overlay.spec.ts'],
  reporter: 'list',
  use: {
