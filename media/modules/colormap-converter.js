...
export class ColormapConverter {
	 ...
	 * @param {ImageData} imageData - The source image data (true colors)
	 ...
	 * @returns {Float32Array} Array of float values (one per pixel)
	 */
	 ...
	 * @param {ArrayLike<number>} rgb - Interleaved pixel data (0-255)
	 * @param {number} width
	 * @param {number} height
	 * @param {number} channels - Number of interleaved channels (3 for RGB, 4 for RGBA)
	 ...
	 */
	decodeRgb(rgb, width, height, channels, colormapName, minValue, maxValue, inverted = false, logarithmic = false) {
