...
export class WebImageProcessor {
    ...
    renderWebImageWithSettings(): ImageData | null {
    ...
    _postFormatInfo(width: number, height: number, channels: number, bitDepth: number, formatLabel: string, formatType: string) {
