...
async function initWasm() {
    ...
    wasmInitPromise = (async () => {
        try {
            ...
            const wasmBindingsPath = /** @type {string} */ ('../wasm/tiff-wasm.js');
 ...
 * @returns {Promise<import('./tiff-tag-utils.js').TagEntry[]>}
 */
export async function extractExifTagsFromBlob(blob) {
